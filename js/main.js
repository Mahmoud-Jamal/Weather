...
async function getData(city) {
    ...
    try {
        var data = await fetch(`https://api.weatherapi.com/v1/forecast.json?key=ec92ba862db642d491b213748240112&q=${city}&days=7`)
        if (data.ok) {
            weather.classList.remove('d-none')
            document.querySelector('.Err').classList.add('d-none')
                        ...
                        <div class="row g-3">
                            <div class="col-6">
                                <div class="rounded-2 bg-m text-center py-2">
                                    ...
                                    <div class="col-6">
                                    <div class="rounded-2 bg-m text-center py-2">
                                    <p class="mb-1">${getDate(result, 3)}</p>
                                    <img src="https:${result.forecast.forecastday[3].day.condition.icon}" alt="" width="70px">
                                    <p class="mb-1 fw-semibold">${result.forecast.forecastday[3].day.condition.text}</p>
                                    <div class="pt-2">
                                        <p class="mb-1">${result.forecast.forecastday[3].day.maxtemp_c} °C</p>
                                        <p class="mb-1 min-temp">${result.forecast.forecastday[3].day.mintemp_c} °C</p>
                                    </div>
                                </div>
                            </div>
                                    <div class="col-6">
                                    <div class="rounded-2 bg-m text-center py-2">
                                    <p class="mb-1">${getDate(result, 4)}</p>
                                    <img src="https:${result.forecast.forecastday[4].day.condition.icon}" alt="" width="70px">
                                    <p class="mb-1 fw-semibold">${result.forecast.forecastday[4].day.condition.text}</p>
                                    <div class="pt-2">
                                        <p class="mb-1">${result.forecast.forecastday[4].day.maxtemp_c} °C</p>
                                        <p class="mb-1 min-temp">${result.forecast.forecastday[4].day.mintemp_c} °C</p>
                                    </div>
                                </div>
                            </div>
                                    <div class="col-6">
                                    <div class="rounded-2 bg-m text-center py-2">
                                    <p class="mb-1">${getDate(result, 5)}</p>
                                    <img src="https:${result.forecast.forecastday[5].day.condition.icon}" alt="" width="70px">
                                    <p class="mb-1 fw-semibold">${result.forecast.forecastday[5].day.condition.text}</p>
                                    <div class="pt-2">
                                        <p class="mb-1">${result.forecast.forecastday[5].day.maxtemp_c} °C</p>
                                        <p class="mb-1 min-temp">${result.forecast.forecastday[5].day.mintemp_c} °C</p>
                                    </div>
                                </div>
                            </div>
                                    <div class="col-6">
                                    <div class="rounded-2 bg-m text-center py-2">
                                    <p class="mb-1">${getDate(result, 6)}</p>
                                    <img src="https:${result.forecast.forecastday[6].day.condition.icon}" alt="" width="70px">
                                    <p class="mb-1 fw-semibold">${result.forecast.forecastday[6].day.condition.text}</p>
                                    <div class="pt-2">
                                        <p class="mb-1">${result.forecast.forecastday[6].day.maxtemp_c} °C</p>
                                        <p class="mb-1 min-temp">${result.forecast.forecastday[6].day.mintemp_c} °C</p>
                                    </div>
                                </div>
                            </div>
                        </div>
